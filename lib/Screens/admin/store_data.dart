...
class _StoreDataPageState extends State<StoreDataPage> {
            ...
            child: StreamBuilder<QuerySnapshot>(
              ...
              builder: (context, snapshot) {
                ...
                final docs = snapshot.data!.docs.where((doc) {
                  ...
                  final code = (data['joinCode'] ?? '').toString().toLowerCase();
                ...
                return ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return _buildStoreCard(data, primaryColor);
                  },
                );
              },
            ),
  ...
  Widget _buildStoreCard(Map<String, dynamic> data, Color primaryColor) {
    final name = data['name'] ?? 'Unknown Store';
    final address = data['address'] ?? 'No Address Provided';
    final phone = data['phone'] ?? 'N/A';
    final code = data['joinCode'] ?? 'N/A';

    String dateAdded = 'N/A';
    if (data['createdAt'] != null) {
      try {
        final Timestamp ts = data['createdAt'];
        dateAdded = DateFormat('MMM d, yyyy').format(ts.toDate());
      } catch (e) {
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child:
            Icon(Icons.storefront_rounded, size: 64, color: Colors.blue[300]),
          ),
